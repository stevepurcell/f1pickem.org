...
class ReportController extends Controller
{
    ...
    public function weeklyreport($raceid)
    {
        $weekly = getPlayersWeeklyStandings($raceid);
        $season = getPlayerStandings();

        return view('reports.weeklyreport', compact('weekly', 'season'));
